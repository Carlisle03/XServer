package carlisle.XServer.commands;
...
public class GamemodeCommand extends Command {
    ...
    public GamemodeCommand() {
        ...
        setDefaultExecutor((sender,context) -> sender.sendMessage("Missing Arguments! Usage: /gamemode <gamemode> or /gm <gamemode>"));
        ...
        addSyntax((sender, context) -> {
            ...
            if(player.getGameMode().equals(gamemode)) {
                Component message = Component.text("Gamemode is already set to ")
                        .color(TextColor.fromHexString("#e2ed4a"))
